...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/confirm
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/secrets/{keyid}
```
...
```text
PUT https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/secrets/{keyid}
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/symmetric-keys/{keyid}/encrypt
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/symmetric-keys/{keyid}/decrypt
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/symmetric-keys/{keyid}/create-local-key
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/symmetric-keys/{keyid}/symmetric-key?keyVersion={keyVersion}
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/asymmetric-keys/{keyid}/sign
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/asymmetric-keys/{keyid}/verify
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/asymmetric-keys/{keyid}/sign-standard
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/asymmetric-keys/{keyid}/verify-standard
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/asymmetric-keys/{keyid}/privateKey?keyVersion={keyVersion}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/asymmetric-keys/{keyid}/publicKey?keyVersion={keyVersion}
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keys/secrets/create
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keys/symmetric-keys/create
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keys/asymmetric-keys/create
```
...
```text
PUT https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keys/{keyid}/delete
```
...
```text
DELETE https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keys/{keyid}
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/auths/ipv4s
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/auths/macs
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/auths/certificates
```
...
```text
PUT https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/auths/ipv4s/delete
```
...
```text
PUT https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/auths/macs/delete
```
...
```text
PUT https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/auths/certificates/delete
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/auths/ipv4s/delete
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/auths/macs/delete
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/auths/certificates/delete
```
...
```text
POST https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores
```
...
```text
PUT https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}
```
...
```text
DELETE https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores?detail={detail}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/keys
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/keys?detail={detail}&type={type}&name={name}&status={status}&pageNumber={pageNumber}&pageSize={pageSize}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/keys/{keyId}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/ips
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/ips?value={ipv4Value}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/macs
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/macs?value={macValue}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/certificates
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.3/appkey/{appkey}/keystores/{keyStoreId}/certificates?value={certificateName}
```
