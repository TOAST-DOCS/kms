...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.0/appkey/{appkey}/keystores
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.0/appkey/{appkey}/keystores?detail={detail}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.0/appkey/{appkey}/keystores/{keyStoreId}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.0/appkey/{appkey}/keystores/{keyStoreId}/keys
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.0/appkey/{appkey}/keystores/{keyStoreId}/keys?detail={detail}&type={type}&name={name}&status={status}&pageNumber={pageNumber}&pageSize={pageSize}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.0/appkey/{appkey}/keystores/{keyStoreId}/keys/{keyId}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.0/appkey/{appkey}/keystores/{keyStoreId}/ips
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.0/appkey/{appkey}/keystores/{keyStoreId}/ips?value={ipv4Value}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.0/appkey/{appkey}/keystores/{keyStoreId}/macs
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.0/appkey/{appkey}/keystores/{keyStoreId}/macs?value={macValue}
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.0/appkey/{appkey}/keystores/{keyStoreId}/certificates
```
...
```text
GET https://api-keymanager.ninc.go.kr/keymanager/v1.0/appkey/{appkey}/keystores/{keyStoreId}/certificates?value={certificateName}
```
