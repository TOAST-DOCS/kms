...
User Access Key와 Secret Access Key는 콘솔의 **API 보안 설정**에서 발급할 수 있습니다. User Access Key 발급 및 사용에 대한 자세한 내용은 [User Access Key](https://docs.nhncloud.com/ko/nhncloud/ko/public-api/user-access-key)를 참고하세요.
