## Security > Secure Key Manager > API v1.3 ガイド
...
v1.3ではトークン認証方式のHTTPヘッダフィールドが追加されます。

```
X-NHN-AUTHORIZATION：{トークン}
```

詳細は[コンソール利用ガイド](/Security/Secure%20Key%20Manager/ko/getting-started/#api)を参照してください。
