...
In v1.3, HTTP header fields for token-based authentication are added.

```
X-NHN-AUTHORIZATION: {token}
```

For more information, see [Console User Guide](/Security/Secure%20Key%20Manager/ko/getting-started/#api).
